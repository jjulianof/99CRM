      ...
      <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
        ...
        >
          ...
          <li className="nav-item">
            <Link
              to="/negocios"
              className={props.page == "negocios" ? linkBlue : linkBlack}
            >
              <i className="fs-4 bi-wallet2"></i>{" "}
              <span className="ms-1 d-none d-sm-inline">Negócios</span>
            </Link>
          </li>
          ...
          <li className="nav-item">
            <a
              href="#"
              className={props.page == "atividades" ? linkBlue : linkBlack}
            >
              <i className="fs-4 bi-calendar4-week"></i>{" "}
              <span className="ms-1 d-none d-sm-inline">Atividades</span>
            </a>
          </li>
          ...
          <li className="nav-item">
            <a
              href="#"
              className={props.page == "config" ? linkBlue : linkBlack}
            >
              <i className="fs-4 bi-gear"></i>{" "}
              <span className="ms-1 d-none d-sm-inline">Configurações</span>
            </a>
          </li>
